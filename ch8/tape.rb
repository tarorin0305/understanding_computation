...
def increment_easier_result(_x, _easier_y, easier_result)
...
def multiply_x_by_zero(_x)
  zero
end

def add_x_to_easier_result(x, _easier_y, easier_result)
  add(x, easier_result)
end
...
def easier_x(easier_x, _easier_result)
  easier_x
end
...
def decrement_easier_result(_x, _easier_y, easier_result)
